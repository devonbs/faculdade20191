            ...
            switch (ri) { //inicia o ciclo de decodificacao de uma instrucao
                ...
                case 30://"out ax"
                    ...
                    if (videoSelecionado) {
                        ...
                        _mem.m[500 + (bx * 40) + cx] = (short) ax; //armazena o caractere na memoria mapeada
                ...
                case 53://"sub bx,ax"
                    ...
                    break;
                case 54://"wait"
                    int tmp = JOptionPane.showConfirmDialog(null,"Instruçao wait", "", JOptionPane.DEFAULT_OPTION);
                    break;
